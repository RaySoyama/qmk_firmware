...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, MU_ON,   KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, MU_OFF, _______, _______, _______, _______, _______, _______,    KC_MNXT,    KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  _______, _______, _______, _______, QWERTY,  _______,  _______, _______, _______,
    _______, _______, _______, MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  TERM_ON, TERM_OFF, _______, _______, _______,
    _______, MEGALO,  _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______
)
  ...
  float megalo_song[][2]     = SONG(MEGALOVANIA);
#endif
