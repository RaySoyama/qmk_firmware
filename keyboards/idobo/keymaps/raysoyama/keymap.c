...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
     * | Control| Windows| LALT   | LOWER  | SPACE  | SPACE  | LEFT   | DOWN   | RIGHT  | SPACE  | RAISE  | LEFT   | DOWN   | UP     | RIGHT  |
     * '--------------------------------------------------------------------------------------------------------------------------------------'
     */
    ...
    KC_LCTL,    KC_LGUI,    KC_LALT,    LOWER,      KC_SPC,     KC_SPC,     KC_LEFT,    KC_DOWN,    KC_RIGHT,       KC_SPC,     RAISE,  KC_LEFT,    KC_DOWN,    KC_UP,    KC_RIGHT),
